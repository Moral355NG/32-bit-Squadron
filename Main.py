...
while run:
    clock.tick(30)  # Set to 30 FPS for slower game speed
    ...
    if page == "game":
        ...
        # Player collision
        if pygame.Rect.colliderect(player, enemy1) or pygame.Rect.colliderect(player, enemy2) or \
           pygame.Rect.colliderect(player, enemy3) or pygame.Rect.colliderect(player, enemy4) or \
